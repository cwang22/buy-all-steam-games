...
@section('content')
    <div class="row">
        <div id="showcase" class="col">
            ...
            <p>Well, it costs <span class="text-danger">${{ $record->sale }}</span> at the moment or <span
                        class="text-danger">${{ $record->original }}</span> if you buy everything at full price.</p>
